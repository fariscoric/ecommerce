...
const FooterComp = () => {
    return(
        <div>
<footer className="bg-neutral-200 dark:bg-neutral-900 relative bottom-0 w-full">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="https://flowbite.com/" className="flex items-center">
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">COMMERCE</span>
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-neutral-900 uppercase dark:text-white">Follow us</h2>
                  <ul className="text-neutral-600 dark:text-neutral-400 font-medium">
                      <li className="mb-4">
                          <a href="https://github.com/fariscoric" className="hover:underline ">Github</a>
                      </li>
                      <li>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              <a href="#" className="text-neutral-500 hover:text-neutral-900 dark:hover:text-white">
              ...
              <a href="https://www.instagram.com/faris.coric" className="text-neutral-500 hover:text-neutral-900 dark:hover:text-white">
              ...
              <a href="https://github.com/fariscoric" className="text-neutral-500 hover:text-neutral-900 dark:hover:text-white">
                  ...
                  <span className="sr-only">https://github.com/fariscoric</span>
              </a>
          </div>
      </div>
    </div>
