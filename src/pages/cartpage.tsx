...
const CartPage = () => {
    ...
    <div className='dark:text-white dark:bg-neutral-700'>
        ...
        <div className='border border-neutral-200 dark:border-red-400 rounded-lg m-10 min-h-64 bg-red-500 dark:bg-red-800'>
        {cartItems.cart.items.map((e:any) => (
                ...
                <div className="flex flex-col justify-between h-36 pl-5 w-full h-auto sm:h-44">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center w-full">
                        ...
                        <button onClick={() => removeHandler(e)} className="dark:bg-red-700 dark:hover:bg-red-800 mt-2 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center dark:focus:ring-red-400">Remove from cart</button></div>
                    </div>
                </div>
                </div>
        ))}
        ...
        <div className='flex flex-row justify-between items-center'>
            ...
            <button className="text-white m-5 bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Proceed to checkout</button>
        </div>
    </div>
  )
}
