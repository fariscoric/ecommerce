...
const HomePage = () => {
    ...
    return (
        <div className='dark:bg-neutral-700'>
            ...
            <button type="button" className="text-white absolute top-1/2 right-5 bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-400" onClick={sliderRight}>
            ...
            <button type="button" className="text-white absolute top-1/2 left-5 bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-400" onClick={sliderLeft}>
...
<div className="m-2 mt-10 w-64 bg-white border border-neutral-200 rounded-lg shadow-lg dark:bg-neutral-800 dark:border-neutral-700 flex flex-col justify-between items-center" >
    ...
    <div className="px-5 pb-5 w-72">
        <div className="flex mx-5 mt-2.5 mb-5">
            <span className="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-800 ml-3">{e.rating.rate}</span>
        </div>
        <div className="flex items-center justify-evenly">
            ...
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-400">Add to cart</button>
        </div>
    </div>
</div>
            ))}
