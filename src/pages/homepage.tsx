...
const HomePage = () => {
    ...
    return (
        <div className='dark:bg-neutral-700 relative'>
            ...
            <button type="button" className="text-white absolute top-1/2 right-5 bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-red-500 dark:hover:bg-red-700 dark:focus:ring-red-400" onClick={sliderRight}>
            ...
            <button type="button" className="text-white absolute top-1/2 left-5 bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-red-500 dark:hover:bg-red-700 dark:focus:ring-red-400" onClick={sliderLeft}>
